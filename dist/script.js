...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2022-03-18');
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        clearInputs(), setTimeout(function () {
...
var modals = function modals(state) {
  function bindModal(modalTrigger, modalBlock, closeSelector) {
    var closeSelectorOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'true';
    ...
    modal.addEventListener('click', function (e) {
      if (e.target === modal && closeSelectorOverlay) {
        windows.forEach(function (item) {
          item.style.display = 'none';
        });
        modal.style.display = 'none';
