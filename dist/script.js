...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_engineer_btn');
});
...
var modals = function modals(modal) {
  var modalTrigger = document.querySelector(modal);
  var trigger = document.querySelectorAll('.contact_us_wrap');
  var modalBlock = document.querySelector('.popup_engineer');
  var modalPopup = document.querySelector('.popup');
  var closePopup = document.querySelector('.popup .popup_close');
